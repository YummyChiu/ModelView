...
public class ImgToSprite : MonoBehaviour
{
    ...
    private static ImgToSprite _instance;

    public static ImgToSprite instance
    {
        get
        {
            ...
            if (_instance == null)
                _instance = GameObject.FindObjectOfType<ImgToSprite>();
            return _instance;
        }
    }
    ...
    public Sprite LoadNewSprite(string FilePath, float PixelsPerUnit = 100.0f)
    {
        ...
        if (SpriteTexture == null)
            MessageBox.Show("Texture is null");
